 clear;clc;close all;
%
load 8310_motor_50Hz.mat
len = 1440;
figure;plot(motor_on_mx_8310(1:len));hold on;plot(motor_off_mx_8310(1:len));grid on;
legend('motor on','motor off');title('mx [mGauss]');

figure;plot(motor_on_my_8310(1:len));hold on;plot(motor_off_my_8310(1:len));grid on;
legend('motor on','motor off');title('my [mGauss]');

figure;plot(motor_on_mx_8310(1:len),motor_on_my_8310(1:len));hold on;grid on;
plot(motor_off_my_8310(1:len),motor_off_my_8310(1:len));
