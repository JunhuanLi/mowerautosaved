function [P_updated,stateVec_updated] = tu_att_ekf_simplified(P,stateVec,angular_imu_rad_s,dt,Q)
%#codegen
...
% eul = quat2eul1(stateVec')*180/pi
% eul_updated = quat2eul(stateVec_updated')*180/pi
