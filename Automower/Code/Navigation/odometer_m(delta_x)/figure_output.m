...
% figure;
% subplot(311);plot(stateVec(4,:));title('stateVec4');grid on
% subplot(312);plot(stateVec(5,:));title('stateVec5');grid on
% subplot(313);plot(stateVec(6,:));title('stateVec6');grid on
% 
