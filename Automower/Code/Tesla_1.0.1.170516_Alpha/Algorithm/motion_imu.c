...
void rotateAngle(T_motion_tracker* obj, float vec_x, float vec_y, T_side rot_dir) //angle is in degree
{
	//转角度测试相关参数
	float											pi_out=0.0;
...
void trackPoint(T_motion_tracker* obj, float vec_x, float vec_y)
{
